...
class MatchDetails:
    ...
    def insert_match_details(self):
        insert_ = "INSERT INTO match_details(match_id,half,minute,action_id,player_id) VALUES(%s,%s,%s,%s,%s)"
        return insert_
    

    # Actions / operations - insert data
    def insert_data(self):
        DataInsertion().insert_single_data(self.insert_match_details)


    def insert_data_tuple(self): # when a tuple of data it's provided
        insert_statement = self.insert_match_details()
