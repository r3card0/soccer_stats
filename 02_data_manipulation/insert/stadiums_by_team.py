...
class StadiumsByTeam:
    ...
    def insert_stadiumsByTeam(self):
        insert_ = "INSERT INTO stadiums_by_team(stadium_id,team_id) VALUES(%s,%s)"
        return insert_
    
    # Actions/operations - insert data
    def insert_data(self): # when a single data is inserted
        insert_statement = self.insert_stadiumsByTeam()
