...
from match_details_insert import MatchDetails
from _path import leagues_file, seasons_file, teams_file, teams_by_season_file, stadiumByTeams, matches, players, players_by_ts, match_players_data, match_details_data
...
md = MatchDetails(match_details_data,['match_id','half','minute','action_id','player_id'])
...
# md_insert_ = md.insert_data_by_row()
