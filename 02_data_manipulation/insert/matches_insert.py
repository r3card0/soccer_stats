...
class Matches:
    ...
    def insert_matches(self):
        insert_ = "INSERT INTO matches(match_no,match_date,stadium_id,local_team_id,visitor_team_id,week_no,round,season_id) VALUES(%s,%s,%s,%s,%s,%s,%s,%s)"
        return insert_
    

    # Actions / operations - insert data
    def insert_data(self):
        DataInsertion().insert_single_data(self.insert_matches)


    def insert_data_tuple(self): # when a tuple of data it's provided
        insert_statement = self.insert_matches()
