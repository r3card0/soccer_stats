...
class Players_team_season:
    ...
    def insert_pts(self):
        insert_ = "INSERT INTO players_by_team_by_season(season_id,team_id,player_id,tshirt) VALUES(%s,%s,%s,%s)"
        return insert_
    

    # Actions / operations - insert data
    def insert_data(self):
        DataInsertion().insert_single_data(self.insert_pts)


    def insert_data_tuple(self): # when a tuple of data it's provided
        insert_statement = self.insert_pts()
